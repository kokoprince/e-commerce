                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="product-status-wrap">
                                ...
                                <input type="hidden" class="number_img_" img_1="" img_2="" img_3="" img_4="">
                                <h4>Products List (Cars) <span class="fel_"></span></h4>
                                ...
                                <table>
                                    ...
                                    <form method="post" class="form_table" enctype="multipart/form-data">
                                        @csrf
                                        @foreach(App\cars::get()->chunk(30) as $ke)
                                            @foreach($ke as $key)
                                            <tr class="t{{$key->id}}" id="{{$key->id}}" >
                                                <td><img class="img_t" src="{{ $key->images ?? 'https://www.shafischools.com/images/service-bg/img-01.jpg'}}" style="width:150px" alt="" /></td>
    ...
    <script>
        $(document).ready(function events(){
            ...
            $('.update_0_img').click(function (event) {
                event.preventDefault();
                var dataa=new FormData($('#box_images_')[0]);
                $.ajax({
                    type: "post",
