                        ...
                        <div class="product-status-wrap">
                            ...
                            <table>
                                ...
                                <form method="post" class="form_table" enctype="multipart/form-data">
                                    @csrf
                                        @foreach(App\clothes::get()->chunk(10) as $ke)
                                            @foreach($ke as $key)
                                                <tr class="t{{$key->id}}" id="{{$key->id}}" >
                                                    ...
                                                    <td>
                                                        @foreach(DB::table('images')->where('id_clothes',$key->id)->get() as $k => $val)
