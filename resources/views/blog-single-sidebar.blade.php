...
<body class="js">
		<!-- Header -->{{--   session()->get('the_pro') session()->get('id_pro')  --}}
					...
					<div class="col-lg-8 col-12">
						<div class="blog-single-main">
							<div class="row">
								<div class="col-12">
									<div class="image">
										<img src="{{ DB::table(session()->get('the_pro'))->find(session()->get('id_pro'))->images }}" alt="#">
									</div>
									<div class="blog-detail">
										<h2 class="blog-title">{{ DB::table(session()->get('the_pro'))->find(session()->get('id_pro'))->name }}</h2>
										<div class="blog-meta">
											<span class="author"><a href="#"><i class="fal fa-usd-circle" style="font-size: 18px;margin-top: 10px"></i>${{ DB::table(session()->get('the_pro'))->find(session()->get('id_pro'))->price }}</a><a href="#" style="color: darkorange"> @switch (DB::table(session()->get('the_pro'))->find(session()->get('id_pro'))->number_evaluation)
                                                        @case (1)
                                                        ...
                                                        @break
                                                    @endswitch<a href="#"><i class="fa fa-comments"></i>Comment (15)</a></span>
										</div>
										<div class="content">
